...
// Card detail view
togglbutton.render('#card-modal-view:not(.toggl)', {observe: true}, function () {
  var link,
...
// Ticket detail view
togglbutton.render('#tickets-show-options-container:not(.toggl)', {observe: true}, function (elem) {
  var link, div,
...
// Epic detail view
togglbutton.render('#epics-show-options-container:not(.toggl)', {observe: true}, function (elem) {
  var link, div,
    description = $('.resource-details .title').textContent.trim(),
    project = $('.project-selector .truncate').textContent.trim(),
    existingTag = $('.sidebar-item.toggl');
