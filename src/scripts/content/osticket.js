...
// Tickets
togglbutton.render('#ticket_tabs_container #ticket_thread:not(.toggl)', { observe: true }, function (elem) {
...
// Tasks
togglbutton.render('#task_thread_container #task_thread_content:not(.toggl)', {
  observe: true
}, function (elem) {
  var link, description,
    titleElem = $('.flush-left a'),
