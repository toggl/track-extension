...
togglbutton.render('li.subtask:not(.toggl)', {observe: true}, function (elem) {
  var titleElem   = $('div.title > span.title-text',elem);
  var projectElem = $('div.task-attr > div.project');
